...
namespace ShopApp.DataAccess.Concrete.EFCore
{
    public static class SeedDatabase
    {
        ...
        {
            new Product(){Name="Samsung S5",Price=1500,ImageUrl="1.jpg",Description="<p>güzel telefon</p>" },
            ...
            new Product(){Name="IPhone 6",Price=3000,ImageUrl="6.jpg",Description="<p>güzel telefon</p>" },
